...
<body>
	...
	<div class="login-box col-md-4 offset-md-4 col-8 offset-2" style="margin-top: 10vh">
		<form id="log" class="form form-horizontal col-10 offset-1">
			...
			<div class="input-group"><h3>Inicia Sesion</h3></div>
			<div class="form-group">
				<div class="input-group">
					
					<input id="user" type="input" class="form-control notnull input" placeholder="Usuario">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<input id="pass" type="password" class="form-control notnull input" placeholder="Contraseña">

  			...
  			<div class="col-4">
  				<form class="form">
					...
					<div class="form-group row">
					  ...
					  <div class=" input-group">
					    <select class="form-control notnull productos" onchange="send(getData('producto',this.value,'producto'))" id="tipo">
					    	<?php
					    		echo $html::option($controller::catalogoSistema(6));
					    	?>
					    </select>
					...
					<div class="form-group row">
					  ...
					  <div class=" input-group">
					    <input type="text" class="form-control input notnull" id="cantidad" value="1">
					    <div class="input-group-addon" id="valcantidad"></div>
					  </div>
					</div>

					<input type="button" class="btn btn-primary" onclick="send(getData('datosProducto',$('#producto').val(),'dataGrid'));" value="Agregar">
					<input type="button" class="btn btn-primary" onclick="arraytoGrid(globalArray);" value="regenerar">
  				</form>
  			</div>
  			<div class="col-8">
  				<table class="table table-striped table-hover">
  					<thead><tr><td>ID</td><td>Proveedor</td><td>Modelo</td><td>Precio de Compra</td><td>Impuesto</td><td>Utlidad</td><td>Cantidad</td></tr></thead>
  					<tbody id="dataGrid"></tbody>
  				</table>

  				<br>
  				<table class="table table-striped table-hover">
  					<thead><tr><td>Costo Total</td></thead>
  					<tbody id="totalGrid"></tbody>
  				</table>
  			</div>

  	...
  	<div class="videos" style="text-align: center;">
  		<div class="row">
  			<div class="col-8 offset-2">
  				<iframe id="player" 
					src="https://www.youtube.com/embed/hxJXiJ3qi70">
				</iframe>
  			</div>
  		</div>
  		<div class="row offset-1 col-10">
  			...
  			<!--Video activaciones-->
  			<div class="col-4"><a href="#" onclick="$('#player').attr('src','https://www.youtube.com/embed/XM7EBFX517A?autoplay=1')">
  				<img width="90%" src="img/thumbnails/thumb-ezvend.jpg"><div class="title">ezvend</div></a>
  			</div>

        <div class="col-4"><a href="#" onclick="$('#player').attr('src','https://www.youtube.com/embed/I_xUMdScWi8?autoplay=1')">
          <img width="90%" src="img/thumbnails/thumb-cajero.jpg"><div class="title">Cajero Inteligente para Retail</div></a>
        </div>

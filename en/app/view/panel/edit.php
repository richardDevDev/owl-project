...
<body id="inicio">
	<nav class="navbar sticky-top  navbar-expand-md navbar-dark bg-dark col-12">
  	...
  	<div id="panel" class="col-10 offset-1">
  		<div class="row">
	  		<div class="col-12">
	  			<div class="title"><label>Editar Marcas</label></div>
  				<br>
  				<form>

  					<div class="form-group row">
					  <label for="example-text-input" class="col-2 col-form-label">Elige p/Editar</label>
					  <div class="col-10 input-group">
					  	<input type="hidden" class="input" id="id_producto"/>

					    <select class="form-control load" id="id" onchange="send(flushForm('load','loadForm'));">
					    	<?php
								$html::option($controller::marcas());
					    	?>
					    </select>

					    <div class="input-group-addon" id="valserie"></div>
					  </div>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10 input-group">
					    <select class="form-control notnull input" id="proveedor">
					    	<?php
					    		echo $html::option($controller::centroCostos());
					    	?>
					    </select>
					    <div class="input-group-addon" id="valproveedor"></div>
					  </div>
					</div>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10 input-group">
					    <input type="text" class="form-control notnull input" id="modelo">
					...
					<div class="form-group row">
					  ...
					  <div class="col-5 input-group">
					    <input type="text" class="form-control notnull input" id="categoria">
					    <div class="input-group-addon" id="valcategoria"></div>
					  </div>
					</div>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10 input-group">
					    <input type="text" class="form-control notnull input" id="precio_compra" placeholder="9999">
					    <div class="input-group-addon" id="valprecio_compra"></div>
					  </div>
					</div>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10 input-group">
					    <input type="text" class="form-control notnull input" id="iva" placeholder="16">
					    <div class="input-group-addon" id="valiva"></div>
					  </div>
					</div>
					...
					<div class="form-group row">
					  <div class="col-10 offset-2" id="mensaje">
					    <input type="button" class="btn btn-warning btn-block" onclick="if (validar()==true) { send(flushForm('input','updateMaquina'))}" value="Guardar">
					  </div>
					</div>

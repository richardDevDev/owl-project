  		...
  		<div class="row">
  			...
  			<div class="col-8 offset-2">
  				<form class="form">
					  ...
					  <label for="example-text-input" class="col-form-label">Nombre de Variante</label>
					  <div class=" input-group">
					  	<input type="text" id="nombre_producto" class="form-control input notnull" placeholder="Basico, Industrial, Refrigerado">
					    <div class="input-group-addon" id="valnombre_producto"></div>
					  </div>
					</div>

					<div class="form-group row">
					  <label for="example-text-input" class="col-form-label">Producto Final</label>
					  <div class=" input-group">
					    <select class="form-control notnull input notnull" id="producto">
					    	<?php
					    		echo $html::option($controller::productosFinales());
					    	?>
					    </select>
					...
					<div class="form-group row">
					  ...
					  <div class=" input-group">
					  	<select class="form-control notnull input notnull" id="tipo">
					    	<?php
					    		echo $html::option($controller::catalogoSistema(5));
					    	?>
					    </select>
					...
					<div class="form-group row">
					  <div class=" input-group">
					  	<input type="button" onclick="send(flushForm('input','addCombo'))" class="btn btn-primary btn-block" value="Guardar">
					  </div>
					</div>


					<div class="form-group row">
					  <div class="col-8 offset-2" id="flash">
					  </div>
					</div>

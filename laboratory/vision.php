         ...
         <header class="masthead">
	      <div class="header-content">
	        <div class="header-content-inner">
	          <br>
	          <h1 id="homeHeading">Visión del área de desarrollos</h1>
	          <hr>
	          
	          <p> Ser el área de I+D para que el grupo vending tenga una tecnologia propia y una
	          capacidad de abastecimiento interno.</p>
	          
	          <p>Proveer de la mejor calidad y caracteristicas de productos mas trazables
	          en el ciclo de desarrollo de un proyecto y/o máquina.</p>
	          
	          <p> Centrar el área de desarrollo para generar productos con 
	          caracteristicas unicas en el mercado.</p>

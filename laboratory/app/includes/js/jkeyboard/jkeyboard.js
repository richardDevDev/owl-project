...
spanish: [
    ...
    var layouts = {
        ...
        symbolic: [
            ['[', ']', '{', '}', '#', '%', '^', '*', '+', '='],
            ['_', '\\', '|', '~', '<', '>'],
            ['character_switch','numeric_switch', '.', ',', '?', '!', "'", 'backspace'],

        ]
    }

    var shift = false, capslock = false, layout = 'spanish', layout_id = 0;
